...
/* ✅ IMPORTANT: Modal MUST be outside Login() to avoid remount on each keystroke */
    ...
    >
      <div className="li-modal">
        ...
        <div className="li-modal-head">
          ...
          {/* ✅ Only one clear cancel affordance: icon close */}
...
export default function Login() {
  ...
  // ✅ when modal opens, focus the email field
  useEffect(() => {
    if (!showForgot) return;
    const t = setTimeout(() => resetEmailRef.current?.focus?.(), 0);
    ...
    <div className="login-layout">
      ...
      <div className="login-form-panel">
        <div className="login-card">
          ...
          {showForgot && (
            <Modal title="Reset your password" onClose={closeForgot}>
              ...
              {/* ✅ Less ambiguous: one primary action only */}
              <div className="li-modal-actions">
                <button
                  type="button"
                  onClick={handleRequestPasswordReset}
                  disabled={resetLoading}
                  className="li-modal-primary"
                  style={{ width: "100%" }}
                >
              ...
              <div className="li-modal-note" style={{ marginTop: 10, fontSize: 12, opacity: 0.75 }}>
